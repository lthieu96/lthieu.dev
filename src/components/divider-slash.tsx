export function DividerSlash() {
	...
	return (
		...
		>
			<svg
				aria-hidden="true"
				className="pointer-events-none absolute inset-0 size-full select-none [z-index:-1] py-[1px] text-zinc-400/70 dark:text-zinc-400/20 !opacity-30 dark:!opacity-60"
			>
				<defs>
					<pattern
						id={patternId}
